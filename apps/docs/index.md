...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/leogenius360/bridge-ui
...
features:
  ...
  - icon: ⚡
    ...
    details: >
      React and Svelte implementations sharing the same type contracts
      and component semantics — with Vue/Solid on the roadmap.
  - icon: 🧩
  ...
  - icon: 🌲
    ...
    details: >
      ESM-first with per-component deep imports. No CSS in component packages.
